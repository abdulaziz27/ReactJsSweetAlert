...
class SiswaRPL extends React.Component {
    constructor(props){
        super(props)
        this.state = {
            namaDaftar : 'Daftar Siswa',
            namaSiswas : [
                {nama : 'Dulziz', nisn : '1234', jurusan : 'RPL'},
                {nama : 'Ariq', nisn : '12345', jurusan : 'RPL'},
                {nama : 'Awal', nisn : '12345', jurusan : 'RPL'},
                {nama : 'Haikal', nisn : '12345', jurusan : 'RPL'},
            ]
        }
    }
    onCLickHandler = () => {
        ...
        this.setState({
            ...
            namaSiswas : [
                {nama : 'Mupit', nisn : '1234', jurusan : 'TKJ'},
                {nama : 'BOM2', nisn : '12345', jurusan : 'TKJ'},
            ]
        })
    }
    render(){
